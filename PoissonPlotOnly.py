...
fig1, ax1 = plt.subplots(5, 2, figsize=(6, 8), sharey=True, sharex=True)
    ...
    for j in range(2):
        ...
        while cond:
            try:
                ...
                x = 2*x
fig1.supxlabel('Values of UTXOs in UTXO Pool')
fig1.supylabel('Frequency')
plt.tight_layout()
plt.show()
fig1.savefig(f'Plots_EqualDepositTarget2/{title}_{iterations}_{datetime.datetime.now().strftime("%d-%m-%Y--%H-%M-%S")}_poisson.jpg', format="jpg")
...
plt.tight_layout()
plt.show()
fig1.savefig(f'Plots_EqualDepositTarget2/{title}_{iterations}_{datetime.datetime.now().strftime("%d-%m-%Y--%H-%M-%S")}_poisson_original.jpg', format="jpg")


fig2, ax2 = plt.subplots(5, 2, figsize=(6, 8), sharey=True, sharex=True)
    ...
    for j in range(2):
        ...
        while cond:
            try:
                ...
                x = 2*x
fig2.supxlabel('Number of Input UTXOs')
fig2.supylabel('Frequency')
plt.tight_layout()
plt.show()
print(maxNumberInputs_old)
fig2.savefig(f'Plots_EqualDepositTarget2/{title}_{iterations}_{datetime.datetime.now().strftime("%d-%m-%Y--%H-%M-%S")}_poisson.jpg', format="jpg")


fig3, ax3 = plt.subplots(5, 2, figsize=(6, 8), sharey=True, sharex=True)
...
plt.tight_layout()
plt.show()
fig3.savefig(f'Plots_EqualDepositTarget2/{title}_{iterations}_{datetime.datetime.now().strftime("%d-%m-%Y--%H-%M-%S")}_poisson.jpg', format="jpg")


fig33, ax33 = plt.subplots(1, 1, figsize=(5,4), sharey=True, sharex=True)
title = "UTXO Pool Size HVF"
ax33.clear()
ax33.grid()
ax33.plot(poolSize['HVF'])
ax33.set_xlim([0, iterations])
ax33.set_ylim([0, 4000])
#ax33.set_ylabel('UTXO Pool Size')
#ax33.set_xlabel('Iterations')
ax33.set_title('HVF', fontsize=10, fontweight='bold')
fig33.supxlabel('Iterations')
fig33.supylabel('UTXO Pool Size')
plt.tight_layout()
plt.show()
fig33.savefig(f'Plots_EqualDepositTarget2/{title}_{iterations}_{datetime.datetime.now().strftime("%d-%m-%Y--%H-%M-%S")}_poisson.jpg', format="jpg")


fig4, ax4 = plt.subplots(1, 1, figsize=(5, 4), sharey=True, sharex=True)
...
fig4.supylabel('UTXO Pool Balance')
fig4.supxlabel('Iterations')
plt.tight_layout()
plt.show()
fig4.savefig(f'Plots_EqualDepositTarget2/{title}_{iterations}_{datetime.datetime.now().strftime("%d-%m-%Y--%H-%M-%S")}_poisson.jpg', format="jpg")



fig5, ax5 = plt.subplots(1, 1, figsize=(5, 4), sharey=True, sharex=True)
...
fig5.supxlabel('Values of Deposits/Targets')
fig5.supylabel('Frequency')
# ax5.set_xlim([0, 4000])
ax5.set_ylim([0, 5000])
...
plt.tight_layout()
plt.show()
fig5.savefig(f'Plots_EqualDepositTarget2/{title}_{iterations}_{datetime.datetime.now().strftime("%d-%m-%Y--%H-%M-%S")}_poisson.jpg', format="jpg")
